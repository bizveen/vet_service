    ...
    return SafeArea(
      child: Scaffold(
       ...
       Align(
         ...
         child: FutureBuilder(
           future: FirebaseDatabaseMethods().getClientFromID(id: widget.sale.clientId!),
             ...
             return
               ContainerWithBorder(
                 child: Padding(
                   ...
                   children: [
                     const Text('To:'),
                     Text(client.name!, style: Get.textTheme.headline6,),
                     Text(client.address!),
                   ],
             ),
                 ),
                ...
                children: [
                  ...
                  ..addAll(widget.sale.inventoryOutList != null
                      ...
                      widget.sale.inventoryOutList!.length,
                          ...
                          price: widget
                              .sale.inventoryOutList![index]!.retailPrice!.toDouble()
                              ))
                      : [])
                  // ..addAll(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(widget.sale.getTotalCharges().toString(), style: Get.textTheme.headline6),
                  ],
                ),
              ),
              TextFieldX(
                  ...
                  onPressed: () async {
                    ...
                    await FirebaseDatabaseMethods().updateBatch(
                        updateSalesJson(
                          ...
                          clientStatus:ClientStatus.values[ widget.sale.clientStatus!],
